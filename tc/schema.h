...
#define HEADER_INFO                                            \
    struct {                                                   \
        ...
        unsigned int userbit3:     HEADER_FIELD_USERBIT;       \
        unsigned int userbit4:     HEADER_FIELD_USERBIT;       \
...
#define GROUP_BY_OUTPUT_KV          0
#define GROUP_BY_OUTPUT_K_LISTS     1
#define GROUP_BY_OUTPUT_V_LISTS     2
#define GROUP_BY_OUTPUT_FULL_LISTS  3
