...
#define MD_DRIVER_CSV     1
#define MD_DRIVER_LETTERS 2
...
typedef int    (*get_distinct_info_t)   (void *op, PQArgs pargs, PByte params, int *distinct_count, int *distinct_base);
